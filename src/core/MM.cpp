...
const QString MM::VERSION = "0.7.0-windows";
...
const QBrush MM::VERTEX_BACKGROUND(QColor(CROSSHAIR_STROKE.red(), CROSSHAIR_STROKE.green(), CROSSHAIR_STROKE.blue(), 127));
...
const qreal MM::VERTEX_SELECT_STROKE_WIDTH = 2.0;
